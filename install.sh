...
download_compoents() {
	...
	pip install --upgrade pip setuptools -i http://pypi.douban.com/simple/
	pip install -r /opt/jumpserver/requirements/requirements.txt -i http://pypi.douban.com/simple/
